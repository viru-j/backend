...
This project is a minimal example of a local code assistant written in Java. It communicates with a local Spirare API model by sending prompts as strings and receiving string responses. The assistant includes a simple Swing-based GUI and utilities for analyzing a Java project.
...
- Analyze a Java source file to list method signatures.
